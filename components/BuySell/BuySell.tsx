  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-4 mb-24 mt-32">
        <div className="text-center flex flex-col items-center rounded hover:shadow-xl hover:bg-blue-100 px-10 py-20 ml-12 border transition-all 0.3s ease-in hover:-translate-y-2 cursor-pointer">
        ...
        <div className="text-center flex flex-col items-center rounded hover:shadow-xl hover:bg-blue-100 px-100 py-20 mr-12 border transition-all 0.3s ease-in hover:-translate-y-2 cursor-pointer">
          <div className="h-40 w-40 ">
            <Image
